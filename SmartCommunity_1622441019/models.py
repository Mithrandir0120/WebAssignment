...
#     userType = EnumField(choices=(('Member', 'Member'), ('Volunteer', 'Volunteer'), ('Admin', 'Admin')), default=1)
...
#     issueType = EnumField(choices=(('Member', 'Member'), ('Volunteer', 'Volunteer'), ('Admin', 'Admin')), default=1)
#
#     class Meta:
#         db_table = 'issue'
#
...
#     providerID = models.AutoField(db_column='provideID', primary_key=True)
...
#     providerType = EnumField(choices=(('Member', 'Member'), ('Volunteer', 'Volunteer'), ('Admin', 'Admin')), default = 1)
#
#     class Meta:
#         managed = False
#         db_table = 'provider'
